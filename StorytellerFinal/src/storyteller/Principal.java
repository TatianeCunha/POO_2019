...
public class Principal {
	public static void main(String[] args) {
		...
		// comeca historia
		Historia historia = new Historia(17);

		Evento e0 = new Evento(Textos.getTexto(jogador, 0), 1);
		Evento e1 = new Evento(Textos.getTexto(jogador, 1), "Verificar lembraca", "Verificar o objeto no chao", 2, 3);
		Evento e2 = new Evento(Textos.getTexto(jogador, 2), "Bater na porta e gritar por ajuda",
				"Verificar o objeto no chao", 8, 3);
		Evento e3 = new Evento(Textos.getTexto(jogador, 3), "Bater na porta e gritar por ajuda",
				"Analisar a escrivaninha ao lado da porta", "Ouvir a fita cassete que esta  no chao", 8, 4, 10);
		Evento e4 = new Evento(Textos.getTexto(jogador, 4), "Tentar abrir a porta", "Olhar a roupa do corpo", 5, 7);
		Evento e5 = new Evento(Textos.getTexto(jogador, 5), "Analisar a escrivaninha ao lado da porta",
				"Olhar a roupa do corpo", 4, 7);
		Evento e6 = new Evento(Textos.getTexto(jogador, 6), "Ver a cama no canto da parede", "Gritar", 9, 12);
		Evento e7 = new Evento(Textos.getTexto(jogador, 7), "Olhar em volta do quarto",
				"Ouvir a fita cassete que esta  no chao", 6, 10);
		...
		Evento e10 = new Evento(Textos.getTexto(jogador, 10), "Olhar a parede", "Gritar",
				"Analisar a escrivaninha ao lado da porta", 11, 12, 4);
		Evento e11 = new Evento(Textos.getTexto(jogador, 11), "Ver a cama no canto da parede", "Tentar abrir a porta",
				"Gritar", 9, 5, 12);
		Evento e12 = new Evento(Textos.getTexto(jogador, 12), 12);
		Evento e13 = new EventoFinal(Textos.getTexto(jogador, 13), 13);
		Evento e14 = new Evento(Textos.getTexto(jogador, 14), "Matar", "Nao matar", 15, 16);
